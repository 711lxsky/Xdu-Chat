...
public class DialogueTimeServiceImpl extends ServiceImpl<DialogueTimeMapper, DialogueTime>
    ...
    public String getInformationForDialogueTime(int curDialogueTime) {
        ...
        return proxyConfig.getNewLineDouble() + dataConfig.getDivideLineMD() +
               proxyConfig.getDialogueTimeTip()  + newDialogueTime +
               dataConfig.getDivideLine()+ proxyConfig.getDialogueTimeMax();
    }
